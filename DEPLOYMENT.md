...
This website uses:
- **Quarto** to generate static HTML files (not Jekyll)
- **GitHub Actions** to automatically build and deploy
- **GitHub Pages** to host the static HTML files

When setting up GitHub Pages, select **"GitHub Actions"** as the source (not Jekyll, not "Deploy from a branch").
...
4. Under **"Source"**, select **"GitHub Actions"** 
   - **Important**: Do NOT select "Deploy from a branch" or Jekyll
   - Select **"GitHub Actions"** - this uses our workflow to build static HTML
5. The page will save automatically

**Note**: This website uses **Static HTML** (generated by Quarto), not Jekyll. The GitHub Actions workflow automatically builds the Quarto site into static HTML files and deploys them to GitHub Pages.
